...
<div class="subpage_view4">
    ...
    <input type="button" value="신규상품 등록"  id="new_product" title="신규상품 등록" class="p_button p_button_color1">
    <input type="button" value="카테고리 등록" id="cate_write" title="카테고리 등록" class="p_button p_button_color2">
    </span>
</div>
</section>
</main>
