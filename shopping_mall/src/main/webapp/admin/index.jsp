    ...
    <section class="admin_bgcolor">
        <div class="admin_login">
            <span>
                <div class="left_div">
                <ul>
                <li><input type="text" class="input_text1" placeholder="관리자 아이디를 입력하세요" name="mid"></li>
                <li><input type="password" class="input_text1" placeholder="관리자 패스워드를 입력하세요" name="mpw"></li>
                </ul>
                </div>
                <div class="right_div">
                    <button type="submit" class="btn_submit" title="MASTER LOGIN" id="btn">MASTER LOGIN</button>
                </div>
